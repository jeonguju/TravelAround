...
<link rel="stylesheet" type="text/css" href="CSS/loginCSS/loginResponsive.css">
...
<div class="super_container">
	...
	<c:if test="${userInfo eq null}">
		<form action="login.do" method="post"  id="login_form">
			<ul>
				<li><input type="text" name="id" placeholder="아이디" required="required"></li>
				<li><input type="password" name="pw" placeholder="비밀번호" required="required"></li>
			</ul>
			<br/>
			<a href="register.do" id="login_register"> 회원가입 </a>
			<br/>
			<button type="submit" id="form_submit_button" class="form_submit_button button trans_200">로그인<span></span><span></span><span></span></button>	
		</form>
	</c:if>
	
	<c:if test="${userInfo ne null }">
		
		<div class="intro_login_success">
		<div class="container">
			<div id="intro_login_success_img" style="background-image:url(img/intro_login_success_img2.jpg)"> </div>
			<div class="intro_login_success_text">
			<h4>${userInfo.id } 님<br/></h4>
				<p class="intro_login_success_text_contents"> <a href="logout.do">로그아웃</a><br/></p>
				<p class="intro_login_success_text_contents"> <a href="modify.do">정보수정</a><br/></p>
			</div>
		</div>
		</div>		
...
<script src="CSS/loginCSS/login_custom.js"></script>
</body>
</html>