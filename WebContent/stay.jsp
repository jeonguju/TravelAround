...
<link rel="stylesheet" type="text/css" href="CSS/stayCSS/stay.css">
<link rel="stylesheet" type="text/css" href="CSS/stayCSS/stayResponsive.css">
...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="img/stay.jpg"></div>
		<div class="home_content">
			<div class="home_title">stay</div>
		</div>
	</div>
					...
					<div class="offers_sorting_container">
						<ul class="offers_sorting">
							<li class="offers_sorting_filter">
								<span class="sorting_text"> 날짜 </span>
								<i class="fas fa-angle-down"></i>
								<ul>
									<li class="sort_btn" ><span>모든 날짜</span></li>
									<li class="sort_btn" ><span> 최근 3개월 </span></li>
								</ul>
							</li>
							<li class="offers_sorting_filter">
								<span class="sorting_text">누구와</span>
								<i class="fas fa-angle-down"></i>
								<ul>
									<li class="sort_btn" ><span>혼자</span></li>
									<li class="sort_btn" ><span>가족</span></li>
									<li class="sort_btn" ><span>연인</span></li>
									<li class="sort_btn" ><span>친구</span></li>
								</ul>
							</li>
							<li class="offers_sorting_search">
								<input type="text" name="searchKeyword_place" placeholder="지역">
								<input type="text" name="searchKeyword_stay" placeholder="숙소">
								<button type="submit"  id="offers_sorting_search_button">검색</button>
							</li>
						</ul>
					</div>
					</form>
...
<script src="CSS/stayCSS/stay_custom.js"></script>
</body>
</html>