...
<link rel="stylesheet" type="text/css" href="CSS/modifyCSS/modify.css">
<link rel="stylesheet" type="text/css" href="CSS/modifyCSS/modifyResponsive.css">
...
<div class="super_container">
				...
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="user_box ml-auto">
							<div class="user_box_login user_box_link"><a href="login.jsp"><i class="material-icons" style="margin-top:7px; font-size:28px; ">face </i></a></div>
							<div class="user_box_register user_box_link"><a href="#" ><i class="material-icons" style="font-size:28px;">mail_outline </i></a></div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container">
		<form action="registerAction.do" method="post">
			<ul>
				<li><input type="text"  name="name" placeholder="이름" size="30" required="required" value="${userInfo.name}" ></li>
				<li><input type="text"  name="id" placeholder="아이디" size="30" required="required"  value="${userInfo.id }"></li>
				...
				<li><input type="email"  name="email" placeholder="이메일" size="20" required="required" value="${userInfo.email }"></li>	
				<li><input type="text"  name="cellphone" placeholder="전화번호" size="20" required="required" value="${userInfo.cellphone }"></li>	
				<li> 
						<div class="form-group" >
							<div class="btn-group" data-toggle="buttons">
								<label class="btn btn-outline-dark">
									<input type="radio"  name="gender"  autocomplete="off"  value="male" ${userInfo.gender eq 'male' ? 'checked':''} >남자
								</label>
								<label class="btn btn-outline-dark">
									<input type="radio"  name="gender" autocomplete="off"  value="female" <c:if test="${userInfo.gender eq 'female'}"> checked </c:if>>여자
								</label>
							</div>
						</div>
				</li>	
			</ul>
			<button type="submit" id="form_submit_button" class="form_submit_button button trans_200">정보수정<span></span><span></span><span></span></button>			
...
<script src="CSS/modifyCSS/modify_custom.js"></script>
